...
//assign image = {image_r[PIXEL*PIXEL-11:WIDTH*PIXEL*PIXEL-24],image_r[PIXEL*(PIXEL-1)-1:WIDTH*PIXEL*(PIXEL-1)-24],image_r[WIDTH*PIXEL*(PIXEL-2)-1:WIDTH*PIXEL*(PIXEL-2)-24]};
