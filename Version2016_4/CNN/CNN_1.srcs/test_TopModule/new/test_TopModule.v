...
TopModule #(.WIDTH(WIDTH),.PIX_W(PIX_W), .PIX_H(PIX_H), .OUTNODE(OUTNODE)) i_top(.clk(clk), .reset(reset), .addrb(addrb), .web(web), .dinb(dinb), .doutb(doutb), .LED(LED));
integer i;
//////////////////////////////////////////////////////
// clock gen.
//////////////////////////////////////////////////////
